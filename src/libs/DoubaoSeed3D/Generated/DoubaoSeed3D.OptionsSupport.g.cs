...
namespace DoubaoSeed3D
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::DoubaoSeed3D.AutoSDKRetryOptions Retry { get; set; } = new global::DoubaoSeed3D.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::DoubaoSeed3D.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::DoubaoSeed3D.IAutoSDKHook>();
        ...
        public global::DoubaoSeed3D.AutoSDKClientOptions AddHook(
            global::DoubaoSeed3D.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::DoubaoSeed3D.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::DoubaoSeed3D.AutoSDKClientOptions UseAuthorizationProvider(
            global::DoubaoSeed3D.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::DoubaoSeed3D.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::DoubaoSeed3D.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::DoubaoSeed3D.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::DoubaoSeed3D.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::DoubaoSeed3D.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::DoubaoSeed3D.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::DoubaoSeed3D.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::DoubaoSeed3D.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::DoubaoSeed3D.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::DoubaoSeed3D.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::DoubaoSeed3D.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::DoubaoSeed3D.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::DoubaoSeed3D.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::DoubaoSeed3D.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::DoubaoSeed3D.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::DoubaoSeed3D.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::DoubaoSeed3D.AutoSDKClientOptions clientOptions,
            global::DoubaoSeed3D.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::DoubaoSeed3D.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::DoubaoSeed3D.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::DoubaoSeed3D.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::DoubaoSeed3D.AutoSDKClientOptions clientOptions,
            global::System.Func<global::DoubaoSeed3D.IAutoSDKHook, global::DoubaoSeed3D.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::DoubaoSeed3D.AutoSDKHookContext context)
        {
